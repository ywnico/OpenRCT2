...
thread_local uint8_t gPeepPalette0[256] = {
    ...
    0x6A, 0x6B, 0x6C, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, // original skin tones (incl hair & shoes...)
...
thread_local uint8_t gPeepPalette1[256] = {
    ...
    0x6A, 0x6A, 0x6B, 0x6B, 0x6C, 0x6C, 0x6D, 0x6D, 0x6E, 0x6E, 0x6F, 0x6F, // replacement skin tones (1)
...
thread_local uint8_t gPeepPalette2[256] = {
    ...
    0xD6, 0xD6, 0xD7, 0xD7, 0x2E, 0x2E, 0x6A, 0x6A, 0x6B, 0x6B, 0x6C, 0x6D, // replacement skin tones (2)
...
thread_local uint8_t gPeepPalette3[256] = {
    ...
    0x22, 0x22, 0x23, 0x24, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B, // replacement skin tones (3)
...
thread_local uint8_t gPeepPalette4[256] = {
    ...
    0x2E, 0x2F, 0x30, 0x31, 0x31, 0x32, 0x32, 0x33, 0x33, 0x34, 0x34, 0x35, // replacement skin tones (4)
